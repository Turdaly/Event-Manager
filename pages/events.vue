  ...
  <div class="t-flex t-flex-col t-gap-4">
    ...
    <div class="t-bg-primary t-p-4">
      ...
      <div class="t-grid t-grid-cols-1 t-gap-8 t-m-4 lg:t-grid-cols-2">
        <EventCard v-for="(item, index) in bodyItems" :key="index" :item="item" />
      </div>
    </div>
  </div>
</template>
...
const bodyItems: Types.Template.BodyItem[] = [
  {
    ...
    paragraph: "Ideal for a business or social virtual meeting with chat and screen sharing.",
    textButton: "Create Meeting",
  },
  {
    img: "/off.png",
    title: "Meeting Offline",
    paragraph: "Ideal for a business or social in-person meeting with necessary arrangements.",
    textButton: "Create Meeting",
  },
  {
    ...
    title: "Webinar",
    paragraph: "Ideal for presentations, lectures, workshops or seminars with an interactive audience.",
  ...
  },
  {
    ...
    title: "Livestream",
    paragraph: "Engage your audience with interactive Livestreaming. Stream to multiple platforms.",
